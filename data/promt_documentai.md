...
`GiaTri`: Trích thông tin số tiền ngay sau cụm từ "tổng mức đầu tư", thường bắt đầu bằng "tổng mức đầu tư..." hoặc "... kinh phí"
...
`TenKMCP`: Tên khoản mục chi phí
`GiaTriTMDTKMCP`: Giá trị tổng mức đầu tư theo khoản mục chi phí
`GiaTriTMDTKMCPTang`: Giá trị tổng mức đầu tư tăng (nếu có)
`GiaTriTMDTKMCPGiam`: Giá trị tổng mức đầu tư giảm (nếu có)
...
`TenNguonVon`: Trích tên nguồn vốn sau cụm từ "nguồn vốn:", nếu không có để ""
`GiaTri`: Trích thông tin số tiền ngay sau cụm từ "giá trị dự toán", thường bắt đầu bằng "Giá trị báo cáo kinh tế kỹ thật..."
`DieuChinh`: Gán `1` nếu "trích yếu văn bản" có chứa nội dung "điều chỉnh...", ngược lại gán `0`
...
### Yêu cầu xử lý:
- Kết quả trả về là chuỗi JSON duy nhất
- Bỏ qua dòng tiêu đề hoặc nhóm, chỉ trích các gói có thông tin chi tiết.
...
`SoVanBan`: Trích số hiệu văn bản ghi ở đầu văn bản, sau chữ "Số:"
`SoVanBanCanCu`: Trích `nguyên số báo cáo đánh giá E-HSDT` Báo cáo đánh giá E-HSDT hoặc Biên bản thương thảo, tại dòng "Căn cứ Báo cáo đánh giá..." hoặc "Căn cứ Biên bản thương thảo..."
`NgayKyCanCu`: Trích "ngày...tháng...năm ..." Báo cáo đánh giá E-HSDT hoặc Biên bản thương thảo, tại dòng "Căn cứ Báo cáo đánh giá..." hoặc "Căn cứ Biên bản thương thảo..." định dạng (dd/MM/yyyy)
`NgayKy`: Trích thông tin ngày ký ở đầu văn bản, sau dòng địa danh "..., ngày ...", định dạng (dd/MM/yyyy)
...
`GiaTri`: Trích thông tin số tiền ngay sau cụm từ "giá chỉ định thầu" hoặc "giá trị trúng thầu", thường tại dòng "Bằng chữ: ..."
`DieuChinh`: Gán `1` nếu "trích yếu văn bản" có chứa nội dung "điều chỉnh...", ngược lại gán `0`.
...
- Nếu số tiền có dấu chấm `.` ngăn cách phần nghìn thì bỏ dấu `.`,  nếu không có giá trị ghi `0`, giá trị là SỐ NGUYÊN
- Nếu có đơn vị tiền tệ, bỏ qua ký hiệu đơn vị tính
{{CHUCNANG13}} Chức năng `Quyết định phê duyệt kết quả lựa chọn nhà thầu (viết tắt: "KQLCNT") giai đoạn thực hiện đầu tư`
